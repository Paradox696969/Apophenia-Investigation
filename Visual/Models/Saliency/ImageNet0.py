...
model = tf.keras.Sequential([
    hub.KerasLayer(
        name='resnet50',
        handle='https://tfhub.dev/google/imagenet/resnet_v2_50/classification/5',
        trainable=False),
])
...
labels = load_imagenet_labels('https://storage.googleapis.com/download.tensorflow.org/data/ImageNetLabels.txt')
print(labels)
...
path_to_saliency = "Visual/Models/Saliency/Samples/"
save_path = "Visual/Models/Saliency/SavedRes/"
