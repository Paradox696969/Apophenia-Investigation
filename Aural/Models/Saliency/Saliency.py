...
model = tf.keras.models.load_model("Aural/Models/Saved/StochasticSpectrogramImproved.h5")

labels = np.array(sorted(os.listdir("Aural/Datasets/Spectrogram Testing Datasets/None")))
print(labels)
...
path_to_saliency = "Aural/Models/Saliency/Input/"
save_path = "Aural/Models/Saliency/Saved/"
